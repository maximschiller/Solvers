...
double **CGvosQ, **Ce, **Zeff, **Qei, **Qeii, **Qeiii, **nuei, **nueii, **nueiii, **neOld, **pe;
double **gamOld, **Rho, **PR, **E, **P;
double **Vde, **Vti, **AnomFreqEl, **TotCollFreq, **EIcollFreq, **ElecGyro, **ElecHall;
double **kTherm, **kIon, **Res, **aSq, **VSq, **Cf, **SpecRadZ, **SpecRadR, **CmSq, **BSq, **jDens, **CoulombLog;
double **jr, **jz;
double **KEold, **KE, **Etherm, **EthOld;
double **uOld[5];
double **u[5], **DissipZ[5];
