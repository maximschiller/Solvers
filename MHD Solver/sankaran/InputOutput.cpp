...
// Variable definition for GetInput function
double MassFlowRate, Jmax, RAD, Ranode, Rcathode, Z, AnodeLength, CathodeLength, TotTime;
int numR=0, numZ=0, J=0, K=0;

// Variable definition for WriteFile function
double **ni, **nii, **niii, **nA, **Vr, **Vz, **Bt, **Jencl, **p, **Te, **Th, **ne, **Potential, **gam, **n, **ph;

int Zone;
int MaxStep = 10;
int numSteps = 0;

double deltaT=1.0e-8, t=0.0;
