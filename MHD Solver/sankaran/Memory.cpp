...
double **DissFlux[5], **DissipR[5], **SourceDiss[5];
double **ElCondR, **ElCondZ, **IonCondR, **IonCondZ, **ThermCondR, **ThermCondZ;
double **ConvFlux[5];
double **EnFluxR, **EnFluxZ, **EnSourceR, **SourceConv[5], **SourceR[5];
double **RdelU[5], **ZdelU[5];
double **Hr[5], **Fr[5], **Dr[5], **Lr[5], **Sr[5], **Hz[5], **Fz[5], **Dz[5], **Lz[5], **Sz[5];
double **Er, **Ez, **ErH, **EzH, **EFr, **EFz;
double **EintEl, **EintH, **FrEn, **FzEn, **DrEn, **DzEn, **SrEn;
double  **ElecComp, **Ohmic, **Exchange;
